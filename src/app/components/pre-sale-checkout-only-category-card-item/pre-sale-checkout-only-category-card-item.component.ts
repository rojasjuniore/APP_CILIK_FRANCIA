...
@Component({
  selector: 'app-pre-sale-checkout-only-category-card-item',
  templateUrl: './pre-sale-checkout-only-category-card-item.component.html',
  styleUrls: ['./pre-sale-checkout-only-category-card-item.component.css']
})
export class PreSaleCheckoutOnlyCategoryCardItemComponent implements OnInit {
