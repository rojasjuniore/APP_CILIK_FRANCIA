...
@Component({
  selector: 'app-claim-full-pass-per-day',
  templateUrl: './claim-full-pass-per-day.component.html',
  styleUrls: ['./claim-full-pass-per-day.component.css']
})
export class ClaimFullPassPerDayComponent implements OnInit {
  @Input() division: any;
  ...
  async onSelectUser(res: any) {
    ...
    try {
      ...
      const accreditationObj = {
        ...
        categoryType: this.division.categoryType,
        endDate: this.division.endDate,
      }
