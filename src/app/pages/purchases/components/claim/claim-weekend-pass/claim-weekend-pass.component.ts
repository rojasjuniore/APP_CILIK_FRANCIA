...
@Component({
  selector: 'app-claim-weekend-pass',
  templateUrl: './claim-weekend-pass.component.html',
  styleUrls: ['./claim-weekend-pass.component.css']
})
export class ClaimWeekendPassComponent implements OnInit {
