...
@Component({
  selector: 'app-pre-sale-only-event-pass-installments-pay-cuota',
  templateUrl: './pre-sale-only-event-pass-installments-pay-cuota.component.html',
  styleUrls: ['./pre-sale-only-event-pass-installments-pay-cuota.component.css']
})
export class PreSaleOnlyEventPassInstallmentsPayCuotaComponent implements OnInit {
