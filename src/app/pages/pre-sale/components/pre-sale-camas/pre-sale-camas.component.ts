...
@Component({
  selector: 'app-pre-sale-camas',
  templateUrl: './pre-sale-camas.component.html',
  styleUrls: ['./pre-sale-camas.component.css']
})
export class PreSaleCamasComponent implements OnInit {
  ...
  Habitacion1(event) {
    ...
    console.log(this.habitacion1+this.habitacion2+this.habitacion3)
 ...
 camaMatrimonial(type:any){
  ...
  ngOnInit(): void {
    ...
    console.log(this.packag)
    this.habitacion1=this.packag.habitacion1;
    this.habitacion2=this.packag.habitacion2;
    this.habitacion3=this.packag.habitacion3;
    if(this.usuario == 1){
  ...
  nextStep(){
    ...
    //this.preSaleSrv.nextStep('step4');
  }
