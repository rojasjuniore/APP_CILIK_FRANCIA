...
@Component({
  selector: 'app-pre-sale-crypto',
  templateUrl: './pre-sale-crypto.component.html',
  styleUrls: ['./pre-sale-crypto.component.css']
})
export class PreSaleCryptoComponent implements OnInit {
